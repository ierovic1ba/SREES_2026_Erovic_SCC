...
Sve matrice koriste natID klase: $\mathbf{Y}_{\text{bus}}$ je \emph{rijetka
kompleksna} matrica (\texttt{sparse::CmplxSolver}), a vektori rezultata koriste
\emph{puni} (dense) tip. Rijetka LU faktorizacija se izvodi jednom, a zatim se
za svaku sabirnicu kvara ponovo koristi (mijenja se samo desna strana sistema),
što je računski efikasno.
...
\begin{table}[H]
  \centering
  \caption{Nivoi kvara po sabirnicama --- case9 (kvar na sabirnici 1).}
  \label{tab:fault}
  \begin{tabular}{crrr}
    \toprule
